...
@section('title', 'Edytuj Przystanek')

@section('header', 'Edytuj Przystanek: ' . $stop->name)
                ...
                <form method="POST" action="{{ route('admin.stops.update', $stop) }}" class="row g-3">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="city_id" name="city_id" required>
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ old('city_id', $stop->city_id) == $city->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch mb-3 mt-3">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $stop->is_active) ? 'checked' : '' }}>
