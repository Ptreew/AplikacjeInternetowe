...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-bus me-2"></i>Nowa linia</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.lines.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label"><i class="fas fa-tag me-2"></i>Typ linii <span class="text-danger">*</span></label>
                        <div class="d-flex">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3" id="number_field_container">
                            <label for="number" class="form-label"><i class="fas fa-route me-2"></i>Numer linii <span class="text-danger">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="name" class="form-label"><i class="fas fa-font me-2"></i>Nazwa linii <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Zapisz linię
                        </button>
                    </div>
                </div>
            </form>
