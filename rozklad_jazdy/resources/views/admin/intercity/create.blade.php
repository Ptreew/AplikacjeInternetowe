            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.intercity.store') }}" class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control @error('line_number') is-invalid @enderror" id="line_number" name="line_number" value="{{ old('line_number') }}" min="1" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('line_name') is-invalid @enderror" id="line_name" name="line_name" value="{{ old('line_name') }}" required>
                        @error('line_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text" style="padding: 0; width: 50px; overflow: hidden;">
                                <input type="color" class="form-control border-0 @error('line_color') is-invalid @enderror" id="line_color" name="line_color" value="{{ old('line_color', '#0066CC') }}" title="Wybierz kolor linii" required style="height: 37px; width: 50px; padding: 0; border: none;">
                            </span>
                            <input type="text" class="form-control @error('line_color') is-invalid @enderror" id="line_color_text" value="{{ old('line_color', '#0066CC') }}" placeholder="#0066CC">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="time" class="form-control @error('arrival_time') is-invalid @enderror" id="arrival_time" name="arrival_time" value="{{ old('arrival_time', '10:00') }}" required>
                        @error('arrival_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
