...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12 d-flex align-items-center">
            <a href="{{ route('admin.tickets.index') }}" class="btn btn-primary"><i class="fas fa-arrow-left me-2"></i>Powrót do listy biletów</a>
        </div>
    </div>
    
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edytuj bilet</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.tickets.update', $ticket) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="user_id" class="form-label"><i class="fas fa-user me-2"></i>Użytkownik <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label for="departure_id" class="form-label"><i class="fas fa-bus me-2"></i>Odjazd <span class="text-danger">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="passenger_name" class="form-label"><i class="fas fa-user-tag me-2"></i>Imię i nazwisko pasażera <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label for="passenger_email" class="form-label"><i class="fas fa-envelope me-2"></i>Email pasażera <span class="text-danger">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="passenger_phone" class="form-label"><i class="fas fa-phone me-2"></i>Telefon pasażera</label>
                    ...
                    <div class="col-md-6">
                        <label for="status" class="form-label"><i class="fas fa-info-circle me-2"></i>Status biletu <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="notes" class="form-label"><i class="fas fa-sticky-note me-2"></i>Uwagi</label>
