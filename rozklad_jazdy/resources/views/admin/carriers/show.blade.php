    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-12">
                ...
                <a href="{{ route('admin.carriers.edit', $carrier) }}" class="btn btn-warning">Edytuj</a>
            </div>
        </div>

        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Szczegóły przewoźnika: {{ $carrier->name }}</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <dl class="row">
                            ...
                            <dt class="col-sm-4">Strona internetowa:</dt>
                            <dd class="col-sm-8">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Linie przewoźnika</h5>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($carrier->lines as $line)
                                    <tr>
                                        ...
                                        <td>{{ $line->name }}</td>
                                        <td>
                                            <a href="{{ route('admin.lines.show', $line) }}" class="btn btn-sm btn-primary">
                                                Szczegóły
                                            </a>
                                        </td>
                                    </tr>
