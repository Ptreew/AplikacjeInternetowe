...
@section('title', 'Dodaj nowy rozkład')
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-2" name="days_of_week[]" value="2" {{ in_array('2', old('days_of_week', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="day-2">Wtorek</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-3" name="days_of_week[]" value="3" {{ in_array('3', old('days_of_week', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="day-3">Środa</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-4" name="days_of_week[]" value="4" {{ in_array('4', old('days_of_week', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="day-4">Czwartek</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-5" name="days_of_week[]" value="5" {{ in_array('5', old('days_of_week', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="day-5">Piątek</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-6" name="days_of_week[]" value="6" {{ in_array('6', old('days_of_week', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="day-6">Sobota</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="day-0" name="days_of_week[]" value="0" {{ in_array('0', old('days_of_week', [])) ? 'checked' : '' }}>
