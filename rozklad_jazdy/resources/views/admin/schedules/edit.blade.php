...
<div class="container">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edytuj rozkład jazdy #{{ $schedule->id }}</h5>
        </div>
        <div class="card-body">
            @if($errors->any())
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            <form action="{{ route('admin.schedules.update', $schedule) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="valid_from" class="form-label"><i class="fas fa-calendar me-2"></i>Data rozpoczęcia <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label for="valid_to" class="form-label"><i class="fas fa-calendar-alt me-2"></i>Data zakończenia <span class="text-danger">*</span></label>
